...
TC001 - Test Basic Dialogue And Relevance
    ...
    [Tags]             ai_core
    Send Prompt And Wait For AI    What is Salesforce Copado used for?
...
TC002 - Test Multi-Turn Conversation Context Retention
    ...
    Send Prompt And Wait For AI    Here is my custom Apex class: public class TaxCalculator { public static Decimal getTax(Decimal amount) { return amount * 0.1; } }
    Send Prompt And Wait For AI    Write a complete Apex unit test for that exact class.
    ${response}=                   Get Last AI Response
...
TC003 - Test Response Formatting For Code Requests
    ...
    [Tags]             ai_formatting
    Select AI Agent    Copado Expert
    Send Prompt And Wait For AI    Write a Salesforce Apex trigger on the Account object that sets the Rating field to 'Hot' before insert if the AnnualRevenue is greater than 100000.
    ${response}=                   Get Last AI Response
...
TC004 - Test Edge Case And Invalid Input Handling
    ...
    [Tags]             ai_edge
    Send Prompt And Wait For AI    ___$$$!!!@@@
    ${response}=                   Get Last AI Response
...
TC005 - Test AI Performance With Complex Data-Driven Prompts
    ...
    FOR    ${prompt}    IN    @{PROMPTS}
        ...
        Send Prompt And Wait For AI    ${prompt}      
...
TC006 - Test Complex Troubleshooting Analysis
    ...
    Send Prompt And Wait For AI    ${complex_prompt}
    ${response}=                   Get Last AI Response
